...
to the menu located at the upper left corner. In this lab we will be using an R Markdown document (.Rmd), so let's start creating one. A menu will show with all the different document types you can create.
...
2.  What type of variable is the column Prev? provide the range of values for this variable in the data
