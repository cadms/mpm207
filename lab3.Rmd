...
2.  Provide a table of the beef farms where the number of movements are
    more than 500, only including the columns: *ID_farm*, *Mun*, *Com*,
    *Census* and *ANIM_mov*

3.  Provide a table summarizing the count, median, and maximum values of
    the TB prevalence by county (Com)
