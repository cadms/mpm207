...
To see this slides online go to: [https://cadms.github.io/mpm207/s/w3.html]()
...
![](img/w3/europeHerds.gif){.fragment fragment-index="4" .fade-in width="70%" .absolute top=80 left=10}

![](img/w3/badgers.png){.fragment fragment-index="5" .fade-in width="50%" .absolute top=135 left=10}
![](img/w3/otherSp.png){.fragment fragment-index="6" .fade-in width="50%" .absolute top=320 left=10}
...
![](img/w3/Tbintersection.png){.fragment fragment-index="0" .fade-in-then-out width="180%"}

![](img/w3/studyArea.png){.fragment fragment-index="1" .fade-in width="180%"}
...
<!-- Old R -->
::::{.fragment fragment-index="0" .fade-in-then-semi-out}
