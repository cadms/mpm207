...
```{r echo=F}
data.frame(
  Feed = c("Pasture", "Keftovers from restaurant", "Leftovers from house", "Pelleted feed"),
  ...
  add_header_above(c("", "Ate" = 2, "Did NOT eat" = 2))
```
...
If you did not get any error messages, means that the library was loaded correctly.
